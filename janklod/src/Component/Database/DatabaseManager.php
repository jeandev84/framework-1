...
class DatabaseManager implements ManagerInterface
{
     ...
     */
     public function __construct(array $configParams = [])
     {
         ...
         $this->defaultConnections = ConnectionStack::getPdoConnections();
         $this->setFactory(new ConnectionFactory($this->defaultConnections));
     }
    ...
    */
    public function connect(string $connection, array $config)
    {
        if (! $this->hasConnection($connection)) {
            ...
            $this->setConnections($this->defaultConnections);
        }
    }
